...
function play() {
    ...
    if (levelUser == "facil") {
       // reset(true);
      showBomb(2);
      alert("linea 99 Estamos comporbando que entra en la comprobación de niveles, nivel: " + levelUser);
...
function randomCards() {
    ...
    $("#" + posiciones[2]).data("src", "./imgs/Charmander.png");
    $("#" + posiciones[3]).data("src", "./imgs/Charmander.png");
    $("#" + posiciones[4]).data("src", "./imgs/Mismagius.png");
    $("#" + posiciones[5]).data("src", "./imgs/Mismagius.png");
    $("#" + posiciones[6]).data("src", "./imgs/groudon.png");
    $("#" + posiciones[7]).data("src", "./imgs/groudon.png");
    $("#" + posiciones[8]).data("src", "./imgs/Jigglypuff.png");
    $("#" + posiciones[9]).data("src", "./imgs/Jigglypuff.png");
    $("#" + posiciones[10]).data("src", "./imgs/Bulbasur.png");
    $("#" + posiciones[11]).data("src", "./imgs/Bulbasur.png");
...
function showBomb(tiempo){
    alert("estamos en la funcion ShowBomb linea 190");
    tiempo = tiempo * 1000;
   // blockInteractions.css("display", "block");
    cards.each(function () {
        if ($(this).children().data("src") == "imgs/bomba.png") {
            alert("Estamos dentro del if de ShowBomba" + $(this).children().data("src"));
            if (tiempo > 0) {
            ...
            alert("No esta encontrando la bomba");
        }
    });
}
